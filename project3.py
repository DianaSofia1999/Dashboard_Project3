    ...
    html.Div(id='transition')
        ...
        return[
            html.Div([
                ...
                html.Label(['Diana Bernardo 90384 - Graphs of World Consumption and Production Per Capita & Energy Transition - Production, Consumption and Production Prediction'],
...
def create_graph_generation(chosen_year,chosen_energy):
    ...
    if chosen_energy==7:
            return html.Div([
                        html.Label(['Geothermal and Biomass Energy (TWh)'],style={'font-size': '20px','marginTop': 2,'textAlign':'center', 'color': 'black', "fontWeight": "bold","margin-left": "3rem"}),
                        dcc.Graph(
                        id='map1',
